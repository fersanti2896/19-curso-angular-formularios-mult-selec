...
export class Convert {
    public static toPaisFrontera(json: string): PaisFrontera {
        return cast(JSON.parse(json), r("PaisFrontera"));
    }

    public static paisFronteraToJson(value: PaisFrontera): string {
        return JSON.stringify(uncast(value, r("PaisFrontera")), null, 2);
    }
}
